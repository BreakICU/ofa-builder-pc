<template>
    <div class="editor-pane"  @click="handleClickCanvas" @keyup.esc="handleKeyup">
        <div class="editor-pane-inner">
            <div class="editor-main" :style="{transform: 'scale(' + scale +')', width: '100%', height: '100%'}">
...
<script>
import {_qk_register_components_object} from '@components-lib/index'
import editShape from '@src/components/EditShape';
...
export default {
    ...
    data(){
        return{
            getCommonStyle: Element.getCommonStyle,
            menuOptions:[
                {
                    title: '复制',
